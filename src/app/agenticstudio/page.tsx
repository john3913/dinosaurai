...
const FEATURES = [
  ...
  { num: '12', title: 'RAG Pipeline',            href: '/agenticstudio/rag',          desc: 'Build retrieval-augmented generation pipelines visually. Configure chunking strategy, overlap, and embedding model, then watch similarity search surface the most relevant chunks in real time.', tags: ['RAG', 'embeddings', 'retrieval'],       color: '#10B981' },
  { num: '13', title: 'Fine-tuning Studio',      href: '/agenticstudio/finetune',     desc: 'Monitor fine-tuning jobs with live animated loss curves. Watch training and eval loss descend epoch by epoch, track BLEU/accuracy/perplexity, and browse training examples side by side.', tags: ['fine-tuning', 'training', 'RLHF'],      color: '#FB7185' },
  { num: '14', title: 'Reasoning Trace',         href: '/agenticstudio/reasoning',    desc: "Visualize Claude's extended thinking as an animated branching tree. Watch reasoning paths expand in real time — confirmed branches glow, dead ends dim, and the synthesis node pulses into view.", tags: ['thinking', 'CoT', 'trace'],             color: '#C084FC' },
  { num: '15', title: 'Prompt Vault',            href: '/agenticstudio/prompt-vault', desc: 'Git-like version control for system prompts. Browse version history, view word-level diffs between versions, track eval scores per version, and deploy the best performer to production.', tags: ['versioning', 'diff', 'prompts'],        color: '#38BDF8' },
  { num: '16', title: 'Token Inspector',         href: '/agenticstudio/tokens',       desc: 'Deep tokenization visualization: paste any text and see every BPE token as a colorful pill with its index. Compare token counts across Claude, GPT-4o, Gemini, and Llama side by side.', tags: ['tokenizer', 'BPE', 'analysis'],         color: '#FACC15' },
  { num: '17', title: 'Latency Profiler',        href: '/agenticstudio/profiler',      desc: "Chrome DevTools–style waterfall chart for AI pipeline latency. Visualize TTFT, streaming fill rate, and tool call overhead across Simple, Tool-Use, and Multi-step agent scenarios.", tags: ['latency', 'TTFT', 'profiling'],          color: '#4ADE80' },
  { num: '18', title: 'Agent Marketplace',       href: '/agenticstudio/marketplace',   desc: 'Browse and install 12+ production-ready agents — research bots, SQL generators, code reviewers, legal parsers. Animated install counts, category filters, and one-click load into Agent Builder.', tags: ['marketplace', 'agents', 'community'],   color: '#F97316' },
  { num: '19', title: 'Compliance Scanner',      href: '/agenticstudio/compliance',    desc: 'Scan AI outputs for PII, medical advice, hallucinations, brand violations, and prompt injection. Inline highlighted violations with severity levels, auto-fix streaming, and rule toggles.', tags: ['compliance', 'PII', 'safety'],          color: '#EF4444' },
  { num: '20', title: 'Semantic Diff',           href: '/agenticstudio/semantic-diff', desc: 'Compare two model responses for meaning divergence. Animated similarity donut, topic coverage dual-bars, hexagonal tone radar chart, and a key-claims divergence table.', tags: ['diff', 'semantic', 'comparison'],        color: '#8B5CF6' },
  { num: '21', title: 'Cost Forecaster',         href: '/agenticstudio/cost-forecast', desc: 'Project 12-month API spend with real-time reactive SVG chart. Adjust DAU, model mix, tokens, caching, and Batch API — watch the cost curve redraw instantly with a budget threshold line.', tags: ['cost', 'forecast', 'budgeting'],        color: '#22C55E' },
  { num: '22', title: 'Canary Deployer',         href: '/agenticstudio/canary',        desc: 'Staged model rollout with live canvas particle flow. Watch traffic split at the fork — stable lane vs canary lane — as you advance through 5%→25%→50%→100% with one-click rollback.', tags: ['canary', 'rollout', 'deployment'],      color: '#FBBF24' },
  { num: '23', title: 'Batch Runner',            href: '/agenticstudio/batch',         desc: 'Run 64 test cases in parallel across an 8×8 grid. Watch cells light up green or red as batches complete, with live pass-rate, category breakdown bars, and failure inspection.', tags: ['batch', 'testing', 'evals'],            color: '#06B6D4' },
];
